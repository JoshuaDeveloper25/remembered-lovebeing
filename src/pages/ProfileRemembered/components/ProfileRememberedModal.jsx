  ...
  return (
    ...
    createPortal(
      ...
      >
        ...
        >
          <div
            className={`relative w-full sm:max-w-[700px] max-w-full sm:px-8 px-0 h-svh mx-auto animate-slide-up`}
          >
            {/* Modal content */}
            <div
              className={twMerge(
                ` shadow bg-white min-h-full`,
                modalContentClassNames
              )}
            >
              {/* Modal header */}
...
export default ProfileRememberedModal;
